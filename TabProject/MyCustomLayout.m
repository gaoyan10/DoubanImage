...
- (void)prepareLayout
{
    ...
    for (int section = 0; section < numberOfSections; section++)
    {
        ...
        for (int item = 0; item < numberOfItems; item++)
        {
            ...
            if (self.collectionView.frame.size.width - xOffset > self.maxmumItemWidth * 1.5f)
            {
    ...
    _contentSize = CGSizeMake(self.collectionView.frame.size.width, yOffset + 100); // 11
}
...
{
    return RAND_FROM_TO(self.minimumItemWidth, self.maxmumItemWidth);
}
